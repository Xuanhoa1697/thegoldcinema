            ...
            <View style={tw`w-full mt-[75px]`}>
                <ScrollView style={tw`w-full px-2`}>
                    {Object.keys(seats).map((item) => {
                        return (
                            <View key={item} style={tw`w-full h-[65px] flex-row items-center justify-between px-3 mt-2 bg-[#c9c9c9] rounded`}>
                                ...
                                <Text style={tw`text-[#000000] text-[14px]`}>{selectedBanggia[item] || defaultDongia} đ</Text>
                            </View>
                        )
                    })}
                </ScrollView>
            ...
            <View style={tw`h-[75px] w-full flex-row items-center justify-between px-2 absolute z-1 bottom-0 bg-white`}>
                <View style={tw`flex items-start justify-start w-full`}>
                    ...
                    <View style={tw`flex-row items-center justify-between w-full`}>
                        <Text style={tw`text-[#000000] text-[14px]`}>{Object.values(selectedBanggia).reduce((a, b) => a + b, 0)} đ</Text>
                        <TouchableOpacity>
